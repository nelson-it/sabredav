        ...
        if (is_array($elems)) foreach ($elems as $elem) {
            ...
            switch ($elem['name']) {
                ...
                case '{' . Plugin::NS_CALDAV . '}time-range' :
                    ...
                    $result['time-range'] = [
                        'start' => ( isset($elem['attributes']['start'])  && $elem['attributes']['start'] != '' ) ? DateTimeParser::parseDateTime($elem['attributes']['start']) : null,
                        'end'   => ( isset($elem['attributes']['end'])    && $elem['attributes']['end'] != ''   ) ? DateTimeParser::parseDateTime($elem['attributes']['end']) : null,
                    ];
